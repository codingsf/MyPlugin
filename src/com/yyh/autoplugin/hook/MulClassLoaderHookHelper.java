 ...
 *多类加载器,当前适用于API23，22
 */
public class MulClassLoaderHookHelper {
    ...
    public static void hookLoadedApkInActivityThread(File apkFile) throws Exception {
        ...
        String odexPath = ApkUtils.getPluginOptDexDir(applicationInfo.packageName).getPath();
        String libDir = ApkUtils.getPluginLibDir(applicationInfo.packageName).getPath();
        ClassLoader classLoader = new PluginClassLoader(apkFile.getPath(), odexPath, libDir, ClassLoader.getSystemClassLoader());
