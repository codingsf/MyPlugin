...
public class ActivityThreadHandlerCallback implements Handler.Callback{
    ...
    private void handleLaunchActivity(Message msg) {
        ...
        try {
            ...
            Intent target = raw.getParcelableExtra(HookHelper.EXTRA_ACTIVITY_INTENT);
            if (target == null) {
				return;
			}
            String targetPackageName = target.getComponent().getPackageName();
            String hostPackageName = ApApplication.getContext().getPackageName();
            if (hostPackageName != null && !targetPackageName.equals(hostPackageName)) {
